...
if (isset($_GET['delete'])) {
    ...
    if ($db->query("DELETE FROM blueprint WHERE id = $id")) {
        $success = "The blueprint has been successfully deleted!";
    } else {
        $error = "Failed to delete the blueprint!";
    }
}
...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <h3 class="text-lg font-bold mb-4 text-gray-800">
        <?= $editData ? 'Edit Blueprint' : 'Add Blueprint' ?>
    </h3>
    ...
    <form method="POST">
        ...
        <div class="mb-4">
            <label class="block mb-2 font-semibold text-gray-700">Tittle *</label>
        ...
        <div class="mb-4">
            <label class="block mb-2 font-semibold text-gray-700">Card Color</label>
        ...
        <div class="flex justify-end space-x-2">
            <?php if ($editData): ?>
                <a href="blueprint.php" class="px-4 py-2 bg-gray-400 text-white rounded-lg">Cancel</a>
            <?php endif; ?>
...
<?php else: ?>
    <div class="col-span-full text-center py-10 bg-white rounded-xl shadow">
        <p class="text-gray-500 text-lg">No blueprint data available</p>
    </div>
<?php endif; ?>
</div>
