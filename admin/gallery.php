...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <h3 class="text-lg font-bold text-gray-800 mb-4">
        <?php echo $editData ? 'Edit' : 'Add'; ?> Photo Gallery
    </h3>
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Activity Tittle *</label>
            <input type="text" name="title" required 
                   ...
                   placeholder="Example: AI Technology Workshop">
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea name="description" rows="3" 
                      class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none"
                      placeholder="Brief description of activities..."><?php echo htmlspecialchars($editData['description'] ?? ''); ?></textarea>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                <label class="block text-gray-700 font-semibold mb-2">Photo <?php echo $editData ? '(Optional - leave blank if you do not want to change)' : '*'; ?></label>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <?php else: ?>
        <div class="col-span-full text-center py-12 bg-white rounded-xl">
            ...
            <p class="text-gray-500 text-lg">No photo in gallery</p>
        </div>
    <?php endif; ?>
</div>
