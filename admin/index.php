...
<div class="rounded-xl shadow-lg p-6 md:p-8 mb-6 md:mb-8 text-white" style="background-color : blue">
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
        <div class="mb-4 md:mb-0">
            <h2 class="text-2xl md:text-3xl font-bold mb-2">Welcome, Admin! 👋</h2>
            <p class="text-purple-100 text-sm md:text-base">Here is a summary of your lab data</p>
        </div>
        <div class="text-left md:text-right">
            <p class="text-purple-100 text-xs md:text-sm">Last login</p>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 md:gap-6 mb-6 md:mb-8">
    ...
    <div class="bg-white rounded-xl shadow-md p-4 md:p-6 hover:shadow-lg transition transform hover:scale-105 duration-200">
        <div class="flex items-center justify-between mb-3 md:mb-4">
            <div class="flex-1 min-w-0">
                <p class="text-gray-600 text-xs md:text-sm mb-1 truncate">Total Lecturers</p>
        ...
        <a href="struktur.php" class="text-green-600 text-xs md:text-sm inline-flex items-center hover:underline">
    ...
    <div class="bg-white rounded-xl shadow-md p-4 md:p-6 hover:shadow-lg transition transform hover:scale-105 duration-200">
        <div class="flex items-center justify-between mb-3 md:mb-4">
            <div class="flex-1 min-w-0">
                <p class="text-gray-600 text-xs md:text-sm mb-1 truncate">Total News</p>
    ...
    <div class="bg-white rounded-xl shadow-md p-4 md:p-6 hover:shadow-lg transition transform hover:scale-105 duration-200">
        <div class="flex items-center justify-between mb-3 md:mb-4">
            <div class="flex-1 min-w-0">
                <p class="text-gray-600 text-xs md:text-sm mb-1 truncate">Total Gallerys</p>
    ...
    <div class="bg-white rounded-xl shadow-md p-4 md:p-6 hover:shadow-lg transition transform hover:scale-105 duration-200">
        <div class="flex items-center justify-between mb-3 md:mb-4">
            <div class="flex-1 min-w-0">    
                <p class="text-gray-600 text-xs md:text-sm mb-1 truncate">New Messages</p>
