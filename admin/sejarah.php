...
$pageTitle = 'History of Laboratory';
$db = new Database();
    ...
    <form method="POST" action="">
        <div class="mb-6">
            <label class="block text-gray-700 font-semibold mb-2">
                <i class="fas fa-book mr-2"></i>Laboratory History *
            </label>
            <textarea name="content" rows="15" required 
                      ...
                      placeholder="Enter the history of the laboratory..."><?php echo htmlspecialchars($data['content'] ?? ''); ?></textarea>
            <p class="text-sm text-gray-600 mt-2">
                <i class="fas fa-info-circle mr-1"></i>Tip: Separate each paragraph with a double enter.
            </p>
        </div>
