...
$pageTitle = 'Manage Sponsors / Collaboration';
$db = new Database();
...
if (isset($_POST['multi_delete']) && !empty($_POST['ids'])) {
    ...
    $success = "Selected sponsors successfully deleted!";
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['multi_delete'])) {
    ...
    if (!$nama_sponsor || !$jenis) {
        $error = "Name sponsor and type are required!";
    }
    ...
    if (!$error) {
        if ($id > 0) {
            ...
            if ($db->query($sql)) {
                $success = "Sponsor successfully added!";
            } else {
...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    <h3 class="text-lg font-bold mb-4"><?= $editData ? "Edit" : "Add" ?> Sponsor</h3>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            <label class="font-semibold">Sponsor Name *</label>
        ...
        <div class="mb-4">
            <label class="font-semibold">Sponsor Type *</label>
        ...
        <div class="mb-4">
            <label class="font-semibold">Sponsor Image (optional)</label>
    ...
    <form method="POST">
        <table class="w-full">
            <thead class="bg-gradient-to-r from-purple-600 to-blue-600 text-white">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left">Sponsor Name</th>
            ...
            <tbody class="divide-y">
                ...
                <?php endforeach; else: ?>
                <tr>
                    <td colspan="5" class="py-6 text-center text-gray-500">Not sponsor data available</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
        ...
        <div class="p-4 border-t flex justify-between">
            <button type="submit" name="multi_delete"
                ...
                onclick="return confirm('Hapus sponsor yang dipilih?')">Delete Selected</button>
