...
<head>
    ...
    <title><?php echo isset($pageTitle) ? $pageTitle . ' - ' : ''; ?>Campus Laboratory</title>
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold gradient-text">Campus lab</h1>
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="<?php echo isset($pageInPages) ? '../' : ''; ?>index.php" class="nav-link text-gray-700 hover:text-blue-600 font-medium">Home Page</a>
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-2 w-56 bg-white rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2">
                            ...
                            <a href="<?php echo isset($pageInPages) ? '' : 'pages/'; ?>sejarah.php" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition">
                                <i class="fas fa-book mr-2"></i>History
                            </a>
                            ...
                            <a href="<?php echo isset($pageInPages) ? '' : 'pages/'; ?>partner_sponsor.php" class="block px-4 py-3 text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition rounded-b-lg">
                                <i class="fas fa-handshake mr-2"></i>Partners & Sponsors
                            </a>
                        </div>
                    </div>
                    
                    <a href="<?php echo isset($pageInPages) ? '' : 'pages/'; ?>news.php" class="nav-link text-gray-700 hover:text-blue-600 font-medium">News</a>
                    <a href="<?php echo isset($pageInPages) ? '../' : ''; ?>index.php#contact" class="nav-link text-gray-700 hover:text-blue-600 font-medium">Contact</a>
