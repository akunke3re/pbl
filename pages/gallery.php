...
<section class="relative py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
        <div data-aos="fade-up">
            ...
            <p class="text-xl text-blue-100 max-w-2xl mx-auto">Documentation of Laboratory Activities and Operations</p>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-6">
                        ...
                        <div class="relative overflow-hidden group">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
                                <button onclick="openModal('<?php echo htmlspecialchars($imageFile); ?>', '<?php echo htmlspecialchars(addslashes($title)); ?>', '<?php echo htmlspecialchars(addslashes($description)); ?>')" 
                                    ...
                                    <i class="fas fa-search-plus mr-2"></i>See Details
                                </button>
                            </div>
                        </div>
                        <div class="p-6">
        ...
        <?php else: ?>
            <div class="text-center py-20">
                ...
                <h3 class="text-2xl font-bold text-gray-700 mb-2">No Gallery Yet</h3>
                <p class="text-gray-500">Documentation of activities will be displayed here</p>
            </div>
        <?php endif; ?>
    </div>
</section>
