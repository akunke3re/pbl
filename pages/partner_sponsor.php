...
<section class="relative py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
        <div data-aos="fade-up">
            ...
            <h1 class="text-5xl md:text-6xl font-bold mb-4">Partners & Sponsors</h1>
            <p class="text-xl text-blue-100 max-w-2xl mx-auto">Partners and Sponsors Supporting Laboratory Activities</p>
        </div>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <p class="text-gray-600 max-w-2xl mx-auto">Strategic partners collaborating in research and development</p>
        </div>
        ...
        <?php else: ?>
            <p class="text-center text-gray-500">No partner yet.p>
        <?php endif; ?>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <div class="w-24 h-1 bg-blue-600 mx-auto mb-4"></div>
            <p class="text-gray-600 max-w-2xl mx-auto">Sponsors supporting laboratory activities and development</p>
        </div>
        ...
        <?php else: ?>
            <p class="text-center text-gray-500">No sponsor yet.</p>
        <?php endif; ?>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-4xl font-bold mb-4 text-gray-800">Benefits of Collaboration</h2>
            <div class="w-24 h-1 bg-blue-600 mx-auto mb-4"></div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div class="text-center" data-aos="fade-up">
                ...
                <h3 class="text-xl font-bold mb-3 text-gray-800">Collaborative Innovation</h3>
                <p class="text-gray-600">Developing innovative solutions through collaborative research & development</p>
            </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="text-gray-600">Sharing knowledge and expertise between institutions</p>
            </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3 class="text-xl font-bold mb-3 text-gray-800">Capacity Enhancement</h3>
                <p class="text-gray-600">Enhancing human resources and infrastructure capacity</p>
            </div>
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                ...
                <h3 class="text-xl font-bold mb-3 text-gray-800">Publication & Certification</h3>
                <p class="text-gray-600">Opportunity for research publication and certification</p>
            </div>
        </div>
    </div>
</section>
