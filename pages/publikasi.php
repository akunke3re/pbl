...
<section class="relative py-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
        <h1 class="text-4xl font-bold mb-2">Publication</h1>
        <p class="text-lg text-blue-100">List of publications for: <strong><?= htmlspecialchars($dosen['nama'] ?? '-') ?></strong></p>
    </div>
</section>
        ...
        <div class="bg-white shadow p-6 mb-6">
            ...
            <?php else: ?>
                <div class="text-center py-8 text-gray-600">
                    ...
                    <p class="mt-4">No publications available for this lecturer.</p>
                </div>
            <?php endif; ?>
        </div>

        <div class="flex justify-between">
            <a href="struktur_organisasi.php" class="px-4 py-2 bg-gray-300 rounded-lg">Back</a>
            <a href="../admin/publikasi.php?dosen_id=<?= $dosen_id ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg">Manage Publications (Admin)</a>
        </div>
    </div>
</section>
