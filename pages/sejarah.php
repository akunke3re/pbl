...
<section class="relative py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
        <div data-aos="fade-up">
            ...
            <h1 class="text-5xl md:text-6xl font-bold mb-4">History</h1>
            <p class="text-xl text-blue-100 max-w-2xl mx-auto">The Journey and Development of Our Laboratory</p>
        </div>
    </div>
</section>
        ...
        <div class="max-w-4xl mx-auto">
                        ...
                        <div class="mt-12 bg-blue-50 border-l-4 border-blue-600 rounded-r-lg px-8 py-6" data-aos="fade-up">
                            <div class="flex items-start">
                                ...
                                <p class="text-gray-700 text-lg italic">
                                    History is the best teacher that teaches us to keep innovating and developing.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <h3 class="text-2xl font-bold text-gray-700 mb-2">No History Yet</h3>
                    <p class="text-gray-500">The laboratory history will be displayed here.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-6">
        <div class="max-w-5xl mx-auto">
            <h2 class="text-3xl font-bold text-center text-gray-800 mb-12" data-aos="fade-up">Our Achievements</h2>
