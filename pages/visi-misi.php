...
<section class="relative py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
        <div data-aos="fade-up">
            ...
            <h1 class="text-5xl md:text-6xl font-bold mb-4">Vision & Mission</h1>
            <p class="text-xl text-blue-100 max-w-2xl mx-auto">Our Laboratory's Vision and Goals</p>
        </div>
    </div>
</section>
        ...
        <div class="max-w-5xl mx-auto">
                        ...
                        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-blue-600">
                            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                                <div class="flex items-center">
                                    ...
                                    <h2 class="text-3xl font-bold text-white">VISION</h2>
                                </div>
                            </div>
                        ...
                        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-t-4 border-blue-600">
                            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                                <div class="flex items-center">
                                    ...
                                    <h2 class="text-3xl font-bold text-white">MISION</h2>
                                </div>
                            </div>
                            <div class="px-8 py-10">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-20">
                    ...
                    <h3 class="text-2xl font-bold text-gray-700 mb-2">No Vision & Mission</h3>
                    <p class="text-gray-500">The laboratory's vision and mission will be displayed here.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
...
<section class="py-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
    <div class="container mx-auto px-6 text-center">
        <h2 class="text-3xl font-bold mb-4" data-aos="fade-up">Join Us</h2>
        <p class="text-blue-100 mb-6 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            Together we realize the laboratory's vision and mission for research and innovation advancement.
        </p>
